...
namespace Mcce.SmartOffice.Api.Managers
{
    ...
    {
        private Booking CreateBooking(UserInfoModel user = null, BookingState state = BookingState.Confirmed)
        {
            return new Booking
            {
        ...
        private Workspace CreateWorkspace(string workspaceName = null)
        {
            return new Workspace
            {
                WorkspaceNumber = workspaceName ?? Make.String()
            };
        }
        ...
        public async Task CreateBooking_ValidatesCollision(Booking existingBooking, SaveBookingModel newBooking, bool collision)
        {
            ...
            var workspace = CreateWorkspace(newBooking.WorkspaceNumber);
